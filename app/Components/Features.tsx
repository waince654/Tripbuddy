    ...
    <section className='pyy-12 md:py-20'>
      <div className='max-w-7xl mx-auto px-4 md:px-6'>
        <div className='text-center mb-12'>
            ...
            <p className='mt-4 text-muted-foreground md:text-xl text-gray-800'>Discover the unique features that make your journey with us extraordinary</p>
        </div>
        <div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-3'>
            {features.map((feature, index)=> (
                <div key={index} className='transition-all bg-red-50 border rounded-lg hover:shadow-lg text-blue-950  '>
